...
//	TIM4->CCR1 = ( 1500 ) ;//+ INIT_DUTY;				//1	
//	TIM4->CCR2 = ( 1500 ) ;//+ INIT_DUTY;				//2
//	TIM4->CCR3 = ( 1500 ) ;//+ INIT_DUTY;				//3	
//	TIM4->CCR4 = ( 1500 ) ;//+ INIT_DUTY;				//4
//	TIM3->CCR1 = ( 1500 ) ;//+ INIT_DUTY;				//1	
//	TIM3->CCR2 = ( 1500 ) ;//+ INIT_DUTY;				//2
//	TIM3->CCR3 = ( 1500 ) ;//+ INIT_DUTY;				//3	
//	TIM3->CCR4 = ( 1500 ) ;//+ INIT_DUTY;				//4
  Set_DJ_PWM();
	if( hz_set > 84000000 )
	{
		return 0;
...
void Set_DJ_PWM(void)
{
  ...
  TIM4->CCR1 = ( LIMIT(dj_out[0],600,2400)/2 ) ;				//1	
	TIM4->CCR2 = ( LIMIT(dj_out[1],600,2400)/2 ) ;				//2
	TIM4->CCR3 = ( LIMIT(dj_out[2],600,2400)/2 ) ;				//3	
	TIM4->CCR4 = ( LIMIT(dj_out[3],600,2400)/2 ) ;				//4
	TIM3->CCR1 = ( LIMIT(dj_out[4],600,2400)/2 ) ;				//1	
	TIM3->CCR2 = ( LIMIT(dj_out[5],600,2400)/2 ) ;				//2
	TIM3->CCR3 = ( LIMIT(dj_out[6],600,2400)/2 ) ;				//3	
	TIM3->CCR4 = ( LIMIT(dj_out[7],600,2400)/2 ) ;				//4
