...
u8 out_protect=1;//³¬ÇøÇøÓò¿çÍÈ
float k_size=0.0068;
float k_force=3.333;//³¬ÏÞÇøÓò´óÐ¡ÔöÒæ
float force_rate=2;//³¬ÏÞÈ¨Öµ¼õÐ¡²½³¤
float size_k;
float limit_deng=11.1111;//µÅÍÈËÙ¶È¿ØÖÆÏÞÖÆ
...
float min_spd=0.3;//³¬ÏÞÈ¨Öµ×îÐ¡Öµ
static u8 stop_leg;
float set_trig_value=0.9;
float center_stable_dead=1.234;//ÖÐÐÄÎÈ¶¨ÅÐ¶ÏËÀÇø
